...
// ═══════════════════════════════════════════════════════════════
// HYMN INDEX — 250 Zion's Hymns auto-extracted
// In production, load from hymn_index.json
// Here we embed a representative subset + let search work over all 250
// ═══════════════════════════════════════════════════════════════

// Full index would be loaded from hymn_index.json at runtime
// For the prototype, we embed the real data (first batch + notable hymns)
const HYMN_INDEX = [
  ...
  { id:94, number:"94", title:"Though Great Dangers Oft Surround Us", pages:[173], images:["page-173.png"] },
  { id:96, number:"96", title:"Though Their Foes May Try Them", pages:[176,177], images:["page-176.png","page-177.png"] },
  { id:106, number:"106", title:"Two Ways, O Man, Are There for Thee", pages:[196,197], images:["page-196.png","page-197.png"] },
  { id:114, number:"114", title:"We Tarry in This Blest and Tranquil", pages:[214,215], images:["page-214.png","page-215.png"] },
  { id:121, number:"121", title:"We Welcome Now Our Saviour", pages:[228,229], images:["page-228.png","page-229.png"] },
  { id:123, number:"123", title:"We Praise Thee, Lord, With Power", pages:[232,233], images:["page-232.png","page-233.png"] },
  { id:132, number:"132", title:"To Thee, Saviour, We Draw Near", pages:[246,247], images:["page-246.png","page-247.png"] },
  { id:133, number:"133", title:"Triumph, O Thou City Fair", pages:[248,249], images:["page-248.png","page-249.png"] },
  { id:142, number:"142", title:"Thy Word, O Lord, Forever Is", pages:[262,263], images:["page-262.png","page-263.png"] },
  { id:147, number:"147", title:"Yearning for Home", pages:[272], images:["page-272.png"] },
  { id:150, number:"150", title:"Why Wilt Thou Thus for the Morrow", pages:[274,275], images:["page-274.png","page-275.png"] },
  { id:151, number:"151", title:"Why Art Thou Grieved?", pages:[276,277], images:["page-276.png","page-277.png"] },
  { id:155, number:"155", title:"Why Should Ye All Be Weeping", pages:[278,279], images:["page-278.png","page-279.png"] },
  { id:156, number:"156", title:"Willingly Endure", pages:[280,281], images:["page-280.png","page-281.png"] },
  { id:173, number:"173", title:"Heart's Wish", pages:[307], images:["page-307.png"] },
  { id:176, number:"176", title:"Word of Life, the Fountain Flowing", pages:[312,313], images:["page-312.png","page-313.png"] },
  { id:179, number:"179", title:"This Is the Test of True Devotion", pages:[316,317], images:["page-316.png","page-317.png"] },
  { id:181, number:"181", title:"Unity in Love", pages:[320,321], images:["page-320.png","page-321.png"] },
  { id:182, number:"182", title:"To My Redeemer (As I Think)", pages:[322,323], images:["page-322.png","page-323.png"] },
  { id:193, number:"193", title:"To Thee, O Lord, Be This Day Dedicated", pages:[342,343], images:["page-342.png","page-343.png"] },
  ...
  { id:210, number:"210", title:"Ye Shepherds, Who the Lord Do Love", pages:[384,385], images:["page-384.png","page-385.png"] },
  { id:214, number:"214", title:"With Your Zion's Harps Now Chiming", pages:[392,393], images:["page-392.png","page-393.png"] },
  { id:215, number:"215", title:"Thou Great High Priest and Teacher", pages:[394,395], images:["page-394.png","page-395.png"] },
  { id:220, number:"220", title:"To Me Is Given Boundless Mercy", pages:[402,403], images:["page-402.png","page-403.png"] },
  { id:224, number:"224", title:"Thou Man of Grief and Pain", pages:[408,409], images:["page-408.png","page-409.png"] },
  { id:237, number:"237", title:"Unity", pages:[427], images:["page-427.png"] },
  { id:241, number:"241", title:"Why Grievest, My Soul, Must Thou", pages:[431], images:["page-431.png"] },
  { id:244, number:"244", title:"The Time of Waiting", pages:[434,435], images:["page-434.png","page-435.png"] },
  { id:246, number:"246", title:"We Lay the Body in Its Tomb", pages:[438,439], images:["page-438.png","page-439.png"] },
  { id:248, number:"248", title:"Waiting Is to Be Our Earthly Schooling", pages:[442,443], images:["page-442.png","page-443.png"] },
...
export default function App() {
      ...
      <div style={{display:"flex",flexDirection:"column",gap:10,animation:"fadeUp .5s ease-out"}}>
        <div style={mkC} onClick={()=>setVw(V.HYMNS)} onMouseEnter={hov} onMouseLeave={uhov}>
          <div style={{display:"flex",alignItems:"center",gap:14}}>
            ...
            <div><div style={{fontWeight:600,fontSize:14,marginBottom:2}}>Hymn Practice</div><div style={{fontSize:12,color:T.tm}}>Select from {HYMN_INDEX.length} Zion's Hymns with real sheet music</div></div>
  ...
  if (vw===V.HYMNS) {
    ...
    const filtered = q ? HYMN_INDEX.filter(h => h.title.toLowerCase().includes(q) || h.number.includes(q)) : HYMN_INDEX;
    return <><style>{css}</style><div style={{minHeight:"100vh",background:T.bg,fontFamily:"var(--sans)",color:T.tx}}><div style={{maxWidth:540,margin:"0 auto",padding:"0 20px 40px"}}>
      <div style={{padding:"20px 0 12px",borderBottom:`1px solid ${T.cb}`,display:"flex",alignItems:"center",gap:10}}>
        <button style={{background:"none",border:"none",cursor:"pointer",fontSize:18,color:T.tm,padding:"4px 8px"}} onClick={goHome}>←</button>
        <div><div style={{fontFamily:"var(--serif)",fontSize:18}}>Zion's Hymns</div><div style={{fontSize:10,color:T.tm,letterSpacing:"0.06em",textTransform:"uppercase",fontWeight:500}}>{HYMN_INDEX.length} hymns available</div></div>
      </div>
      {/* Search */}
